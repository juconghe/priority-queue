...
import structures.JAbstractArrayHeap;
...
public class Configuration {
	 ...
	 * and Deadline #2
	 */
	public static final String STUDENT_ID = "28650090";
	...
	public static <P, V> AbstractArrayHeap<P, V> getArrayHeap(
		...
		return new JAbstractArrayHeap<P,V>(comparator);
	}
